...
local basic_map = {
    ...
    -- insert mode
    ['i|<A-u>'] = map('<up>'):noremap():silent(),
    ['i|<A-e>'] = map('<down>'):noremap():silent(),
    ['i|<A-n>'] = map('<left>'):noremap():silent(),
    ['i|<A-i>'] = map('<right>'):noremap():silent(), -- DO NOT use <C-i>, it's same as <Tab> on terminal
}
