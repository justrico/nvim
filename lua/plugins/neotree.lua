...
neotree.setup({
    ...
    window = {
        ...
        mappings = {
            ...
            ["<C-x>"] = "open_split",
            ["<C-v>"] = "open_vsplit",
            ["S"] = "noop", -- disable default open_split key
            ["s"] = "noop", -- disable default open_vsplit key
            ...
            ["e"] = "noop", -- disable default toggle_auto_expand_width key
            ["q"] = "close_window",
            ["R"] = "refresh",
            ["?"] = "show_help",
            ["<"] = "prev_source",
    ...
    filesystem = {
        ...
        window = {
            mappings = {
                ...
                ["f"] = "filter_on_submit",
                ["<c-f>"] = "clear_filter",
                ["<c-x>"] = "noop", -- disable default clear_filter key
                ["[g"] = "prev_git_modified",
                ["]g"] = "next_git_modified",
                ["e"] = "noop",
            }
